                    ...
                    <div id="page-content">
                                    ...
                                    <form action="#" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                                        ...
                                        <div class="form-group form-actions">
                                            <div class="col-md-9 col-md-offset-3">
                                                <button type="submit" class="btn btn-effect-ripple btn-primary" onclick="issutype_report_chart();">Submit</button>
							...
							<div class="col-lg-3">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2>Overall Exceptions by Issue Type</h2>
                                    </div>
                                    ...
                                    <table class="table table-striped table-borderless table-vcenter">
										...
										//print_r($issuetype_report);
											foreach ($issuetype_report as $issueresult):
											
											echo "<tr>";
											echo "<td>".$issueresult['rp_issuetype']."</td>";
											echo "<td>".$issueresult['totalissue']."</td></tr>";
							...
							<div class="col-lg-9">
									...
									<input type="hidden" id="chartvalues" value='<?php echo$issuetype_report_charts;?>'>
										<!-- Partial Responsive Block -->
								<div class="block">
