                ...
                <div class="col-lg-7">
                    <div class="panel panel-default">
                        ...
                        <div class="checkbox">
                         ...
                         <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="removemade">Remove "Made in Canada"
    ...
    <script src="../dist/js/sb-admin-2.js"></script>
		...
		<script type="text/javascript">
			...
			var panellabels = "";
				...
				if (document.getElementById("removelogo").checked==true){
					var removelogo = "yes";
				}else{
					var removelogo = "no";
				}
				if (document.getElementById("removemade").checked==true){
					var removemade = "yes";
				}else{
					var removemade = "no";
				}
				...
				window.open('pdf/print-grid.php?projname='+projname+'&projnamecontinued='+projnamecontinued+'&projnumber='+projnumber+'&start='+startinglabel+'&end='+endinglabel+panellabels+'&option1='+option1+'&removelogo='+removelogo+'&removemade='+removemade);
				...
				window.open('pdf/print-grid.php?projname='+projname+'&projnamecontinued='+projnamecontinued+'&projnumber='+projnumber+'&start='+startinglabel+'&end='+endinglabel+'&option1='+option1+panellabels+'&removelogo='+removelogo+'&removemade='+removemade);
